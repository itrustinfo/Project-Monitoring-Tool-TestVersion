...
namespace ProjectManagementTool.DAL
{
    public class Constants
    {
        ...
        "Back to DTL by AEE","Back to DTL by EE"};
        public static List<string> AeeApproval = new List<string>() { "Code A", "Code B", "Code C", "Code D", "Network Design DTL Reviewed", "ONTB DTL Verified" };
