    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void ExporttoPDF(GridView gd, int type,string isPrint)
        {
            try
            {
                ...
                Phrase phApplicationName = new Phrase(Environment.NewLine + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Issues", FontFactory.GetFont("Arial", ApplicationNameSize, iTextSharp.text.Font.BOLD));
        ...
        protected void btnexcelexport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl1' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Issues Report</asp:Label><br />" +
